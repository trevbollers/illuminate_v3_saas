...
import { Trophy, Loader2, ArrowLeft, Smartphone, Mail } from "lucide-react";
...
type LoginMode = "choose" | "email-password" | "magic-code" | "magic-code-verify";
...
export default function LeagueLoginPage() {
  ...
  const [error, setError] = useState(
    errorParam === "invalid_account"
      ? "This account is not associated with a league."
      : "",
  );
            ...
            <CardContent>
              <form onSubmit={handleEmailPassword} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label>Email</Label>
                  <Input type="email" placeholder="admin@league.org" value={email} onChange={(e) => setEmail(e.target.value)} autoFocus required />
                </div>
                <div className="space-y-2">
          ...
          <>
            ...
            <CardContent>
              <form onSubmit={handleVerifyCode} className="space-y-4">
                ...
                />
                <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700" disabled={loading || code.length !== 6}>
